...
export function LaboratoryPage() {
  ...
  const handleResultSubmit = async () => {
    if (!selectedInvestigation || (!result && !resultFile)) {
                      ...
                      {!patient ? (
                        ...
                        patientInvestigations.map((investigation) => (
                          ...
                          >
                            ...
                            <TableCell>
                              {investigation.requestedBy.firstName}{" "}
                              {investigation.requestedBy.lastName}
                            </TableCell>
                            <TableCell>
                              {investigation.status === "Pending" && (
                                <Button
                ...
                {investigationToDelete && (
                  <div className="bg-muted p-4 rounded-lg space-y-2">
                    ...
                    <div className="flex justify-between text-sm">
                      ...
                      <span className="font-medium">
                        {format(new Date(investigationToDelete.createdAt), "MMM d, yyyy")}
                      </span>
                    </div>
                  </div>
                )}
